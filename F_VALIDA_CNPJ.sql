/****** Object:  UserDefinedFunction [dbo].[F_VALIDA_CNPJ]    Script Date: 12/02/2025 13:21:38 ******/
...
/*
  ...
  USO:  
    SELECT DBO.F_VALIDA_CNPJ( '57.043.148/0001-20' )
    SELECT DBO.F_VALIDA_CNPJ_OLD( '57043148000120' )
    SELECT DBO.F_VALIDA_CNPJ( '18344996000119' )
    SELECT DBO.F_VALIDA_CNPJ_OLD( '18344996000119' )
    SELECT DBO.F_VALIDA_CNPJ( '12ABC34501DE35' ) 
    SELECT DBO.F_VALIDA_CNPJ( '58505959000169' )
    SELECT DBO.F_VALIDA_CNPJ_OLD( '58505959000169' )
